...
<div class="container">
    ...
    <div class="posts">
        ...
        <div class="row my-3 d-flex align-items-center justify-content-between" style="margin-left: 0; margin-right: 0; padding: 0; min-height: 70px; border-radius: 15px; background: #fff; box-shadow: 0px 1px 5px 1px rgba(7,7,7,0.1)">
                <h5 class="col-lg-auto py-3 mx-3" style="margin: 0"><strong>{{$post->id}}.</strong></h5>
                <img class="col-lg-1" style="min-height: 80px; max-height: 380px; object-fit: cover" src="/storage/{{$post->cover}}"/>
            ...
            <div class="col-md-auto my-3">
                ...
                <a href="{{route('posts.destroy', $post->id)}}" onclick="event.preventDefault();document.getElementById('delete-form').submit();" class="btn btn-danger col-md-auto"><img src="{{asset('/images/trash.svg')}}" height="18px" width="18px"></a>
